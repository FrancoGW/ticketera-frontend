...
import { FiHome, FiPlus, FiUser, FiBarChart2, FiFileText, FiDollarSign, FiUsers, FiPackage, FiShoppingCart } from "react-icons/fi";
...
const SellerSidebar = () => {
  ...
  const baseItems = [
    ...
    { path: '/seller/punto-venta', icon: FiShoppingCart, label: 'Punto de venta' },
